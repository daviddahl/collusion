...
function filterSince(timestamp){
    console.error('Creating filter for connections since ' + new Date(timestamp));
    console.error('Timestamp is an actual date: ' + typeof timestamp);
    console.error('Timestamp has a legitimate value: ' + timestamp.valueOf());
    return {
        name: 'since',
        index: 'timestamp',
